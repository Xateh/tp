...
/**
 * Extractor that builds {@code InfoViewCommand}s
 */
public class InfoViewCommandExtractor {
     ...
     * @return InfoViewCommand that can be executed.
     * @throws ValidationException When the command parameters fail to validate.
     */
    public static InfoViewCommand extract(BareCommand bareCommand) throws ValidationException {
        ...
        return new InfoViewCommand(index);
    }
}
