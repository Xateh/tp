...
public class CommandTestUtil {
    ...
    public static final String NAME_DESC_AMY = " " + "/name:" + escapeWithQuotes(VALID_NAME_AMY);
    public static final String NAME_DESC_BOB = " " + "/name:" + escapeWithQuotes(VALID_NAME_BOB);
    ...
    public static final String EMAIL_DESC_AMY = " " + "/email:" + escapeWithQuotes(VALID_EMAIL_AMY);
    public static final String EMAIL_DESC_BOB = " " + "/email:" + escapeWithQuotes(VALID_EMAIL_BOB);
    public static final String ADDRESS_DESC_AMY = " " + "/address:" + escapeWithQuotes(VALID_ADDRESS_AMY);
    public static final String ADDRESS_DESC_BOB = " " + "/address:" + escapeWithQuotes(VALID_ADDRESS_BOB);
    ...
    public static final String INVALID_ADDRESS_DESC = " " + "/address:"; // empty string not allowed for addresses
    ...
    public static void showPersonAtIndex(Model model, Index targetIndex) {
        ...
        model.updateFilteredPersonList(new FieldContainsKeywordsPredicate(Arrays.asList(splitName[0])));

        assertEquals(1, model.getFilteredPersonList().size());
    }

    /**
     * Returns an input string wrapped in quotes, to escape special characters when simulating user input.
     *
     * @param input Input to be wrapped in quotes.
     * @return Input wrapped in quotes.
     */
    public static String escapeWithQuotes(String input) {
        return "\"" + input + "\"";
    }
}
